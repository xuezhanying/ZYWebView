...
#import "ZY_NJKWebViewProgress.h"
#import <TargetConditionals.h>
#import <dlfcn.h>
#import <WebKit/WebKit.h>

@interface ZYWebView()<UIWebViewDelegate,WKNavigationDelegate,WKUIDelegate,IMY_NJKWebViewProgressDelegate>
...
@property (nonatomic, strong) ZY_NJKWebViewProgress* njkWebViewProgress;
@end
...
-(void)initUIWebView
{
    ...
    self.njkWebViewProgress = [[ZY_NJKWebViewProgress alloc] init];
